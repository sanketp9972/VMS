...
//		.antMatchers("/cars/**").hasRole("ADMIN")
		...
		.antMatchers("/cars/images/**").permitAll()
		.antMatchers("/users/**").permitAll()
//		.antMatchers("/salesperson/**").hasRole("SALESPERSON")
		.antMatchers("/salesperson/**").permitAll()
		.antMatchers("/bookings/**","/insurance/**", "/finance/**", "/testdrive/**", "/services/**").permitAll()
